 ...
 *    - Cell A1: Key
 *    - Cell B1: Value
 * 4. Add rows for each of your deployed scripts. The "Key" must be one of the five keys listed below. The "Value" is the corresponding web app URL you get after deploying each script.
 *    
 *    Example Setup:
 *    | Key             | Value (URL from deploying the corresponding script file)          |
 *    |-----------------|-------------------------------------------------------------------|
 *    | tasks           | URL from deploying `google-apps-script.js`                        |
 *    | conditions      | URL from deploying `production-conditions-apps-script.js`         |
 *    | scheduledTasks  | URL from deploying `get-scheduled-apps-script.js`                 |
 *    | tracking        | URL from deploying `save-tracking-apps-script.js`                 |
 *    | save            | Use the same URL as 'tracking'                                    |
 *
